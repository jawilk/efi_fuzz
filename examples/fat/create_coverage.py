...
image = 'modules/Fat_noinline.efi'
...
coverage_path = 'compute-afl/coverage/'
...
for i, file in enumerate(files):
    ...
    subprocess.run(['python3', script_path, 'run', image, '--extra-modules', 'modules/EnglishDxe.efi', '--coverage-file', coverage_path+'cov_'+str(i)+'.log', '-v', '../../nvram.pickle', '-a', file_path, 'fat', 'Setup'])
